...
public class JanelaRelatorioProdutoTempo extends javax.swing.JInternalFrame {

    private ResultSet rs;
    private final Tabela listaPedido;
    private String granularidadeRelatorio;

    public JanelaRelatorioProdutoTempo() {
        initComponents();
    ...
    cb_regiao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Mes", "Ano", "Dia", "Trimestre", "Semestre" }));
    ...
    atualizacaoPedidos.setText("Relatório de Vendas Produto X Tempo");
    ...
    public void gerarPDF() {
        ...
        pdf.gerarPF("ProdutoXTempo_" + granularidadeRelatorio, "Relatório de venda de Produto X Tempo");
    }
    ...
    private void gerarRelatorioProdutoTempo(String produto, String tempo, String dataInicio, String dataFim, String proc) {
        granularidadeRelatorio = produto + "X" + tempo;
        //granularidade 1
        ...
        if (Conector.getInstance().gerarConexao()) {
            try {
                ...
                if (produto.equals("todos_os_produtos")) {
                    listaPedido.criarColuna(tempo);
                    listaPedido.criarColuna("Faturamento");
                    while (rs.next()) {
                        nomeLinha = rs.getString(tempo); // Obtem Tempo
                    ...
                    while (rs.next()) {
                        ...
                        nomeColuna = rs.getString(tempo); // Obtem Tempo
                        valorFaturamento = rs.getString("faturamento_total"); // Obtem faturamento
    ...
    private void btn_gerar_relatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_gerar_relatorioActionPerformed
        ...
        if (dataInicioFimValida(dataInicio, dataFim)) {
            ...
            gerarRelatorioProdutoTempo((String) cb_produtos.getSelectedItem(), (String) cb_regiao.getSelectedItem(),
                    dataInicio, dataFim, "Vendas_ProdutoXTempo(?, ?, ?, ?, ?, ?, ?, ?, ?);");
